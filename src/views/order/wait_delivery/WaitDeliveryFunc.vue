<template>
  <div class="col-md-3 text-md-right d-print-none j-func">
    ...
    <a class="btn btn-default mb-2 mb-md-3" href="javascript:void(0);" @click.prevent="$emit('refresh', $event.target)"><i class="fa fa-refresh"></i>&nbsp;&nbsp;刷新</a>
