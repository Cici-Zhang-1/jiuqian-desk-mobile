<template>
  <div class="tab-pane fade" id="dismantleY" role="tabpanel" aria-labelledby="wardrobe">
...
export default {
  ...
  computed: {
    ...
    activeOrderProduct: {
      get () {
        return this.$store.getters.getActiveDismantleData({ uri: this.dismantleUrl, child: 'Y' })
      }
    }
  },
  created () {
