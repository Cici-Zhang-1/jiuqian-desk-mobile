<template>
  <div class="tab-pane fade" id="dismantleD" role="tabpanel" aria-labelledby="wardrobe">
    <div class="form-row" v-if="orderProduct">
      <input type="hidden" name="order_product_wardrobe_struct_id" v-model="activeOrderProduct['struct']['v']" v-if="activeOrderProduct && activeOrderProduct['struct']" />
    ...
    <table class="table-center table-form table table-bordered table-responsive text-nowrap" id="dismantleDTable" v-if="!loading && activeOrderProduct">
      <thead>
      <tr>
        <th class="td-xs" >#</th>
...
export default {
  ...
  computed: {
    ...
    activeOrderProduct: {
      get () {
        return this.$store.getters.getActiveDismantleData({ uri: this.dismantleUrl, child: 'D' })
      }
    }
  },
  created () {
  ...
  mounted () {
    this.highlightTr('dismantleDTable')
    this.addLine('dismantleDTable')
    this.handleDirection('dismantleDTable')
  ...
  updated () {
    this.highlightTr('dismantleDTable')
    this.addLine('dismantleDTable')
    this.copy('dismantleDTable')
    this.handleDirection('dismantleDTable')
    this.disposeAppendLine('dismantleDTable')
  },
  methods: {
